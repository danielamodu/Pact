          ...
          <header className="w-full pt-8 pb-4 relative z-50">
            <div className="w-full px-8 md:px-14 flex justify-between items-center">
              ...
              <div className="flex items-center gap-8">
                ...
                <Link href="/privacy" id="nav-privacy-btn" style={{ color: "white", fontSize: 14, fontWeight: 700, opacity: 1 }} className="hover:opacity-80 transition-opacity">Privacy</Link>
